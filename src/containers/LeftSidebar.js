...
import logoImg from '../assets/images/Ekoguard.png'
        ...
        <div className="drawer-side ">
            ...
            <XMarkIcon className="h-5 inline-block w-5"/>
                ...
                <li className="mb-2 font-semibold text-xl">
                    ...
                    <Link to={'/app/welcome'}><img className="mask mask-squircle w-10" src={logoImg} alt="DashWind Logo"/>EkoGuard</Link> </li>
                {
                    routes.map((route, k) => {
                        return(
                            <li className="" key={k}>
